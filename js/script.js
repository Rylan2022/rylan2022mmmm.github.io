...
function main() {
    ...
    document.getElementById("clear-completed").addEventListener("click", function () {
        ...
        document.querySelectorAll(".card.checked").forEach(function (card) {
            deleteIndexs.push([...document.querySelectorAll(".todos .card")].indexOf(card));
...
// removeManyTodo FUNCTION TO REMOVE MNY TODOS
...
// addTodo() FUNCTION TO LIST/CREATE TODOS AND EVENT LISTENERS
